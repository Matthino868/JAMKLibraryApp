...
const Filters: React.FC<FiltersProps> = ({
    ...
    return (
        <div className="w-full">
            <h1 className="font-semibold text-white text-xl mt-5 md:text-black">Filters</h1>
            <div className="p-4 bg-white shadow-lg rounded-md w-full overflow-y-auto">
                ...
                <div className="slidecontainer">
                    ...
                    <div className="flex items-center justify-between">
                        <input className="w-full h-2 bg-blue-300 rounded-lg  cursor-pointer hover:bg-gray-400 focus:outline-none " type="range" min="1" max="2000" value={minPages} onChange={(e) => setMinPages(Number(e.target.value))} />
                        <p>{minPages}</p>
                    </div>
                    <p>No. max pages:</p>
                    <div className="flex items-center justify-between">
